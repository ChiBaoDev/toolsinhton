...
|---|---:|---:|---|---|---|---|---|---|---|
| Portable | Host 125% | 1920x1080 physical | Fresh disposable profile | Start without settings | First displayed main window is Vietnamese | First displayed window was `Không có tiêu đề - Subtitle Edit v5.1.0-rc5`; pre-construction timing was not instrumented separately | `%TEMP%\SE14-portable-tmpr9t_q\startup.png` | - | PASS |
...
| BLOCK-ENV-02 | Verification | The active Windows desktop became unavailable to mouse/UI Automation while completing the authorized 1280x720 rows | OPEN; 1280x720 rows not run |
